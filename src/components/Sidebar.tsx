...
const ToolPanel: React.FC<ToolPanelProps> = ({ title, icon, children }) => {
  ...
  return (
    <div className="mb-2 border border-[#2b2d31] rounded">
      <button 
        className="w-full flex items-center p-2 bg-[#2b2d31] text-left"
...
export const Sidebar: React.FC = () => {
  return (
    <div className="w-64 overflow-y-auto bg-[#2b2d31] p-2 flex flex-col">
      <ToolPanel 
        title="Form Elements" 
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            ...
            <div className="flex space-x-1">
              <button className="p-1 bg-[#36373d] hover:bg-[#404249] rounded">◀</button>
              <button className="p-1 bg-[#36373d] hover:bg-[#404249] rounded">▶</button>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-2">
